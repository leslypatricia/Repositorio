...
<table border="1" class="color-Tabla">
	...
	<?php
$sql="SELECT * from tipohoraextra" ;

	$res=mysqli_query($conexion,$sql);
	while($mostrar=mysqli_fetch_array($res)){
		echo "<tr>";
		echo "<td>";echo $mostrar['Cod_Tipo_HE']; echo"</td>";
		echo "<td>";echo $mostrar['Descripcion']; echo"</td>";
		echo "<td>";echo $mostrar['SueldoHora']; echo"</td>";
		echo "<td><a href='Eliminar.php?CTHE=".$mostrar['Cod_Tipo_HE']."'><button name='Eliminar'  class='boton-eliminar'><i class='far fa-trash-alt'></a></i></button></td>";
	    echo "<td><a href='Actualizar.php?CTHE=".$mostrar['Cod_Tipo_HE']."'><button name='Actualizar' class='boton-actualizar'><i class='fas fa-edit'></a></i></button></td>";
	   echo "<tr>";
