...
$sql="SELECT * from deducciones";
	...
	while($mostrar=mysqli_fetch_array($res)){
		...
		echo "<td><a href='Eliminar.php?CD=".$mostrar['Cod_Deducciones']."'><button name='Eliminar'  class='boton-eliminar'><i class='far fa-trash-alt'></a></i></button></td>";
		echo "<td><a href='Actualizar.php?CD=".$mostrar['Cod_Deducciones']."'><button name='Actualizar' class='boton-actualizar'><i class='fas fa-edit'></a></i></button></td>";
		echo "</td>";
