<?php
$con=consulta($_GET['CJ']);
function consulta($CJ){
		$db_host="localhost";
		$db_usuario="root";
		$db_contra="";
		$db_nombre="nominas";
		...
		$sentencia="SELECT Cod_Jornada,Tipo_Jornada FROM jornada where Cod_Jornada='".$CJ."'";
...
header("location:Jornada/Jornada1.php");
}
?>
<?php
if (isset($_POST["BD"])){
...
<td><input type="text" name="CJ" value="<?php echo $con[0]; echo $codigo ?>" size="5" maxlength="5" /></td></tr>
<tr><td><label>Tipo Jornada:</label></td>
<td><input type="text" name="TJ" value="<?php echo $con[1]; echo $jornada?>" size="15" maxlength="15" /></td></tr>
</table>
