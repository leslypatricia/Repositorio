...
<div class="Container">
  ...
  <div class="form-group">
	...
	<button name="Insertar"  class="boton_Añadir">Añadir Jornada  <i class="fas fa-plus"></i></button>
...
;
	...
	while($mostrar=mysqli_fetch_array($res)){
		...
		echo "<td>";echo $mostrar['Tipo_Jornada']; echo"</td>";
		echo "<td><a href='Eliminar.php?CJ=".$mostrar['Cod_Jornada']."'><button name='Eliminar'  class='boton-eliminar'><i class='far fa-trash-alt'></a></i></button></td>";
	    echo "<td><a href='Actualizar.php?CJ=".$mostrar['Cod_Jornada']."'><button name='Actualizar' class='boton-actualizar'><i class='fas fa-edit'></a></i></button></td>";
	   echo "<tr>";
	?>
