<?php
$con=consulta($_GET['FP']);
function consulta($FP){
		$db_host="localhost";
		$db_usuario="root";
		$db_contra="";
		$db_nombre="nominas";
...
header("location:FormaPago/FormaPago1.php");
}
?>
<?php
if (isset($_POST["BD"])){
...
<td><input type="text" name="FP" value="<?php echo $con[0]; echo $codigo;?>" size="5" maxlength="5" /></td></tr>
