...
JOIN aumento as a on ng.Cod_Aumento=a.Cod_Aumento" ;
	...
	while($mostrar=mysqli_fetch_array($res)){
		...
		echo "<td>";echo $mostrar['Total']; echo"</td>";
		echo "<td>";echo $mostrar['Fecha_Generada']; echo"</td>";
