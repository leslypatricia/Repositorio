<?php
$con=consulta($_GET['CR']);
function consulta($CR){
		$db_host="localhost";
		$db_usuario="root";
		$db_contra="";
		$db_nombre="nominas";
...
<td><input type="text" name="CR" value="<?php echo $con[0]; echo $CRO?>" size="5" maxlength="5" /></td></tr>

<tr><td><label>Descripcion:</label></td>
<td><input type="text" name="D" value="<?php echo $con[1];echo $Descripcion?>" size="15" maxlength="15" />
